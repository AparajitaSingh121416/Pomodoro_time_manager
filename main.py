...
start_button = Button(text="Start", background= "white", width=5, command=start_timer)
start_button.grid(column=0, row=2)

reset_button = Button(text="Reset", background= "white", width=5, command=reset_timer)
reset_button.grid(column=2, row=2)

tick = Label( foreground=GREEN, background=YELLOW)
